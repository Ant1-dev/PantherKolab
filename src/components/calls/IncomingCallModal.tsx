    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full mx-4 animate-in fade-in zoom-in duration-300">
        <div className="text-center">
          ...
          {/* Caller Info */}
          <h2 className="text-3xl font-bold text-gray-900 mb-2">{callerName}</h2>
          ...
          <div className="flex gap-6 justify-center">
            ...
            >
              <div className="w-16 h-16 rounded-full bg-green-500 hover:bg-green-600 flex items-center justify-center text-white transition-all shadow-lg hover:shadow-xl group-hover:scale-110">
