...
export function LoginForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-96 h-auto p-8 bg-white rounded-xl shadow-[0px_4px_16px_0px_rgba(0,0,0,0.08)] flex flex-col justify-start items-start gap-4 overflow-hidden login-form-container">
