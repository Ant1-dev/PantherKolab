...
import { ConfirmEmailForm, confirmEmailStyles } from '@/components/auth/confirm-email';

function ConfirmEmailContent() {
  return (
    <div
      className="w-full h-screen relative bg-sky-600 shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] overflow-hidden"
      style={confirmEmailStyles.root}
    >
      {/* Right side - Confirmation form */}
      <div className="w-1/2 h-full px-16 py-24 right-0 top-0 absolute bg-gray-50 inline-flex flex-col items-center overflow-hidden gap-y-8">
        <ConfirmEmailForm />
      ...
      <div
        ...
        style={confirmEmailStyles.decorativePaws}
      />
    </div>
  );
}
